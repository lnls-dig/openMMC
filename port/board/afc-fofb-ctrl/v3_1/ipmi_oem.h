...
/**
 * @file afc-fofb-ctrl/v3_1/ipmi_oem.h
 * @brief Custom IPMI commands for AFC FOFB CTRL
 *
 * @ingroup AFC_FOFB_CTRL_V3_1_IPMI_OEM
 */

/**
 * @defgroup AFC_FOFB_CTRL_V3_1_IPMI_OEM AFC-FOFB-CTRLv3.1 IPMI OEM Commands
 * @ingroup AFC_FOFB_CTRL_V3_1
 * @{
 */
