...
/**
 * @defgroup AFC_FOFB_CTRL_V3_1 AFC-FOFB-CTRLv3.1 Board Port
 * @ingroup BOARD_PORTS
 */

/**
 * @file afc-fofb-ctrl/v3_1/pin_mapping.h
 * @brief Hardware pin definitions for AFC-FOFB-CTRLv3.1
 *
 * @ingroup AFC_FOFB_CTRL_V3_1_PIN_MAPPING
 */

/**
 * @defgroup AFC_AFC_FOFB_CTRL_V3_1_PIN_MAPPING AFC-FOFB-CTRLv3.1 Pin Mapping
 * @ingroup AFC_AFC_FOFB_CTRL_V3_1
 * @{
 */
