...
#define AMC_FRU_FILE_ID             "SAYMAFRU"       // Allows knowing the source of the FRU present in the memory
...
#define AMC_PRODUCT_VERSION         "v2.0"
...
#define AMC_CLOCK_CONFIGURATION_LIST                                    \
    ...
    DIRECT_CLOCK_CONNECTION(TCLKA, APP, NO_PLL, RECEIVER, UNSPEC_FAMILY, 0, MHz(150), MHz(149), MHz(151)) \
    DIRECT_CLOCK_CONNECTION(TCLKB, APP, NO_PLL, RECEIVER, UNSPEC_FAMILY, 0, MHz(100), MHz(99), MHz(101))
...
#define AMC_COMPATIBILITY_CODE               0x5341594d
