...
const SDR_type_01h_t SDR_LM75_RTM_IC4 = {
...
const SDR_type_01h_t SDR_LM75_RTM_IC6 = {
    ...
    .reserved2 = 0x00, /* reserved */
    .OEM = 0x00, /* OEM reserved */
    .IDtypelen = 0xc0 | STR_SIZE("TEMP RTM IC6"), /* 8 bit ASCII, number of bytes */
    .IDstring = "TEMP RTM IC6" /* sensor string */
};

const SDR_type_01h_t SDR_LM75_RTM_IC8 = {
    ...
    .reserved2 = 0x00, /* reserved */
    .OEM = 0x00, /* OEM reserved */
    .IDtypelen = 0xc0 | STR_SIZE("TEMP RTM IC8"), /* 8 bit ASCII, number of bytes */
    .IDstring = "TEMP RTM IC8" /* sensor string */
};
#endif
...
#ifdef MODULE_LM75
    sdr_insert_entry( TYPE_01, (void *) &SDR_LM75_RTM_IC4, &vTaskLM75_Handle, 0, CHIP_ID_RTM_LM75_0 );
    sdr_insert_entry( TYPE_01, (void *) &SDR_LM75_RTM_IC6, &vTaskLM75_Handle, 0, CHIP_ID_RTM_LM75_1 );
    sdr_insert_entry( TYPE_01, (void *) &SDR_LM75_RTM_IC8, &vTaskLM75_Handle, 0, CHIP_ID_RTM_LM75_2 );
#endif
