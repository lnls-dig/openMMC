...
#define tskIPMI_HANDLERS_PRIORITY	(tskIDLE_PRIORITY+3)
#define tskIPMI_PRIORITY		(tskIDLE_PRIORITY+3)

#define tskIPMB_RX_PRIORITY		(tskIDLE_PRIORITY+4)
#define tskIPMB_TX_PRIORITY		(tskIDLE_PRIORITY+4)
